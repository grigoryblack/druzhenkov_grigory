export const SKILLS = [
  { id: 1, name: 'Russian', description: ['Native language'], rating: 5 },
  { id: 2, name: 'English', description: ['Second language'], rating: 4 },
  {
    id: 3,
    name: 'Web Development',
    description: ['HTML', 'CSS (SCSS)', 'JavaScript (ES6+)', 'SSR', 'SPA', 'PWA'],
    rating: 5,
  },
  {
    id: 4,
  ...
  { id: 6, name: 'Build Tools', description: ['Vite.js for React', 'Webpack'], rating: 4 },
  {
    id: 7,
    name: 'UI Libraries',
    description: ['Ant Design', 'MUI', 'Carbon Design System', 'shadcn/ui'],
    rating: 4,
  },
  {
    id: 8,
    name: 'Animation Libraries',
    description: ['Framer Motion', 'Tailwind CSS', 'Custom components'],
    rating: 4,
  },
  ...
  { id: 12, name: 'Version Control', description: ['Git'], rating: 5 },
  {
    id: 13,
    name: 'Design Tools',
    description: ['Figma', 'Photoshop (PH)', 'Illustrator'],
    rating: 3,
  },
  {
    id: 14,
    name: 'Backend',
    description: ['Express.js', 'Node.js', 'Nest.js', 'Swagger UI', 'Postman'],
    rating: 4,
  },
  ...
  { id: 17, name: 'DevOps', description: ['Basic DevOps Experience'], rating: 2 },
  {
    id: 18,
    name: 'Code Review',
    description: ['Experience and Knowledge of Code Review'],
    rating: 4,
  },
  {
    id: 19,
    name: 'Methodologies',
    description: ['BEM', 'FSD', 'DRY', 'KISS', 'Clean architecture '],
    rating: 5,
  },
  {
    id: 20,
    name: 'Responsive Design',
    description: ['Mobile First', 'Adaptivity', 'Fluid', 'Flex box', 'Grid'],
    rating: 5,
  },
];
