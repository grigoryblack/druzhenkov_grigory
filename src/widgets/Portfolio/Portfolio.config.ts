import CableWalkerPng from "../../assets/img/Works/CableWalkerMain.png";
import CallibriPng from "../../assets/img/Works/callibri.png";
import SimpleItPng from "../../assets/img/Works/simpleit.png";
import KampusPng from "../../assets/img/Works/Campus.png";
import KillnoisePng from "../../assets/img/Works/killnoise.png";

import CableWalkerWebp from "../../assets/img/Works/CableWalkerMain.webp";
import CallibriWebp from "../../assets/img/Works/callibri.webp";
import SimpleItWebp from "../../assets/img/Works/simpleit.webp";
import KampusWebp from "../../assets/img/Works/Campus.webp";
import KillnoiseWebp from "../../assets/img/Works/killnoise.webp";
...
export const projectsConfig = [
  ...
  },
  {
    ...
    webpSrc: KampusWebp,
    experience:
      'Created CRM for analyzing scholarships paid, collecting statistics and downloading data on them.<br><br>Stack: React, TS, Scss, MUI, Redux Toolkit, SSR, Docker, Spring Boot.',
  },
  {
    name: 'KILLNOISE',
    description:
    ...
    src: KillnoisePng,
    webpSrc: KillnoiseWebp,
    experience:
      'Simple landing with mailer',
  },
];
